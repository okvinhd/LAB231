...
import dao.impl.TypeServiceDAOImpl;
...
public class HomeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<TypeService> typeService
                    = new TypeServiceDAOImpl().getAllTypeService();
            ...
            if (check) {
                ArrayList<Service> listService = serviceDAO.getService(name,
            ...
            request.setAttribute("error", "Cannot open database");
     ...
     * It is an ArrayList containing the Service object
     * @param idType is the id type of the service user want to search. It is an
     * string
     * @return true or false
     */
    private boolean checkIdType(ArrayList<TypeService> typeService, String idType) {
